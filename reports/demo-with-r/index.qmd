...
There is not built-in implementation to fold code output. Therefore, we use the quarto extension [`quarto-collapse-output`](https://github.com/mcanouil/quarto-collapse-output) to enable this functionality.

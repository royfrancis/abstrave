...
`[This is a badge]{.badge-primary}`  [This is a badge]{.badge-primary}

`[This is a badge]{.badge-secondary}`  [This is a badge]{.badge-secondary}
...
::: {.aside}
Call-Out blocks are documented [here](https://quarto.org/docs/authoring/callouts.html)
:::

## Call-Outs

Variants of call-out
...
```         
::: {layout-ncol=3}
![Caption for figure 1](assets/featured.jpg){#fig-layout-1}

![Caption for figure 2](assets/featured.jpg){#fig-layout-2}

![Caption for figure 3](assets/featured.jpg){#fig-layout-3}
:::
```
...
```
![](assets/featured.jpg){.absolute top=250 left=0 height="450"}
![](assets/featured.jpg){.absolute top=200 right=50 height="250"}
![](assets/featured.jpg){.absolute bottom=0 right=200 height="200"}
```
